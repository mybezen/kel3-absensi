...
<div class="flex flex-col bg-white items-center pt-[4rem]">
    <div class="flex items-center justify-center rounded-2xl h-[3rem] text-center w-full bg-[#E0E5B6] text-2xl font-bold text-black mb-5">
        ONTIME
    </div>
    <div class="w-full bg-white shadow-md p-6 text-center">
        ...
        <div class="mb-5">
            ...
            <h2 class="text-lg poppins-semibold text-[#686D57]">Jhosep Rafael</h2>
